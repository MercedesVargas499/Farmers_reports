...
::: {.page-intro}
The map below shows the **corn yield spatial distribution** across Field 3, displayed in quantiles (red = lower yield zones, green = higher yield zones). The blue line marks the field boundary and the dashed line separates the two sub-fields. A full statistical comparison between Control and Treatment strips will be added once the yield data CSV is available.
:::
...
<figure style="margin: 20px 0; text-align: center;">
  ...
  />
  <figcaption style="font-size: 0.82rem; color: #6b7280; margin-top: 8px;">
    <strong>Figure 2.</strong> Corn yield map — Villnave Field 3, 2025 season.
    Color scale in quantiles:
    <span style="background:#d73027; color:#fff; border-radius:4px; padding:1px 7px; font-size:0.78rem; margin-left:4px;">■ Low yield</span>
    <span style="background:#f46d43; color:#fff; border-radius:4px; padding:1px 7px; font-size:0.78rem; margin-left:2px;">■</span>
    <span style="background:#fdae61; color:#fff; border-radius:4px; padding:1px 7px; font-size:0.78rem; margin-left:2px;">■</span>
    <span style="background:#a6d96a; color:#fff; border-radius:4px; padding:1px 7px; font-size:0.78rem; margin-left:2px;">■</span>
    <span style="background:#1a9641; color:#fff; border-radius:4px; padding:1px 7px; font-size:0.78rem; margin-left:2px;">■ High yield</span>
  </figcaption>
</figure>
